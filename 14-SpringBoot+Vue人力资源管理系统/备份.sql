...
) ENGINE = InnoDB AUTO_INCREMENT = 259 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工考勤表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `att_leave`  (
  ...
  `type_num` tinyint(0) UNSIGNED NULL DEFAULT NULL COMMENT '休假类型',
...
CREATE TABLE `att_overtime`  (
  ...
  `type_num` int(0) NULL DEFAULT NULL COMMENT '加班类型',
  `dept_id` int(0) NULL DEFAULT NULL COMMENT '部门id',
...
CREATE TABLE `att_staff_leave`  (
  ...
  `type_num` int(0) NULL DEFAULT NULL COMMENT '请假类型id',
  ...
  `is_deleted` tinyint(0) UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工请假表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sal_salary`  (
  ...
  `is_deleted` tinyint(0) UNSIGNED NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工工资表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sal_salary_deduct`  (
  ...
  `type_num` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '扣款类型，0迟到，1早退，2旷工，3休假',
  `deduct` int(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '每次扣款金额',
...
CREATE TABLE `sys_docs`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 51 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文件表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_staff`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 37 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '员工表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_staff
-- ----------------------------
INSERT INTO `sys_staff` VALUES (1, 'admin', '邱杰', 0, 'E10A83EE057F20F8DC3949BA59ABBE56', '9ee44e0dc945e5a41828.jpg', '2000-12-05', '13991849313', '上海', '海归', 12, 1, '2022-01-22 19:46:27', '2023-10-16 18:06:42', 0);
